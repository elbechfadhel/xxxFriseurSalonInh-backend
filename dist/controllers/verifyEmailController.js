...
exports.confirmCode = exports.sendCode = void 0;
...
const M = {
    ...
    plainText: (lang, code, minutes) => lang === 'en'
...
`;
const compileTemplate = handlebars_1.default.compile(TEMPLATE_SRC);
// Try to resolve your logo path for attachment
async function resolveLogoPath() {
    const candidates = [
        path_1.default.resolve(process.cwd(), 'src/email/assets/logo.png'),
        path_1.default.resolve(process.cwd(), 'src/assets/logo.png'),
