...
INSERT INTO "new_Reservation" ("createdAt", "customerName", "date", "employeeId", "id", "phone", "service") SELECT "createdAt", "customerName", "date", "employeeId", "id", "phone", "service" FROM "Reservation";
